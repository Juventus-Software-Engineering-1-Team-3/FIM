...
public class ConsoleClient {
	...
	public static void main(String[] args) {
		...
		// default:
		// System.out.println("Bitte geben Sie eine g�ltige Nummer ein!");
		// mainMenu();
		}
	...
	private static void createVehicle() {
		...
		// IVehicle vehicle = vehicleFactory.createVehicle(vehicleId, brand, model,
		// licensePlate);

		System.out.println("\nVehicle created!\n*****************\n");

		System.out.println("[<==] Dr�cken Sie eine bliebige Taste um zum Men� zur�ckzukehren...");
		inputScan.nextLine();

		// Test message
		System.out.println("Gehe zum Men�...");
		// TODO: uncomment, when mainMenu method is implemented
		// mainMenu();
	 ...
	 * System.out.println("\n\n##### Fahrzeug suchen #####");
	 * 
	 * System.out.println("\nBitte Fahrzeug ID eingeben:"); vehicleId =
	 * Integer.parseInt(inputScan.nextLine());
	 * 
	 * VehicleFactory vehicleFactory = vehicleFactory.getInstance(); IVehicle
	 * vehicle = vehicleFactory.findVehicle(vehicleId);
	 * 
	 * inputScan.close();
	 * 
	 * }
